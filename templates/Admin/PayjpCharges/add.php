 ...
 * @var \Cake\Collection\CollectionInterface|string[] $pointBooks
 */
?>
<div class="container-fluid">
    <div class="page-title-box">
        <h4 class="page-title">Payjp Charges 追加</h4>
    </div>
    ...
    <div class="row mx-1 my-1">
        ...
        <?= $this->Form->create($payjpCharge, ['novalidate' => true]) ?>
                    ...
                    <div class="col-6"></div>
                        ...
                        <?= $this->Form->control('payjp_charge_code', ['type' => 'text', 'label' => 'payjp_charge_code']) ?>
                    </div>
                    <div class="col-6"></div>
                                </div>                            <div class="row">                    <div class="col-6">
